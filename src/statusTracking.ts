/**
 * Tracks reply-delivery health per channel (InReach reply-page POST, plain email,
 * SMS/TwiML, plus the nightly canary) in KV. The Garmin reply page (src/replyToInreach.ts) is an unofficial, undocumented
