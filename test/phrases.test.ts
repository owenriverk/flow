...
live('tier 1 — exact alias', () => {
  test.each([
    ...
    ['mk',                      'Kings R (Middle Fork)'],
    ['fantasy falls',           'Fantasy Falls'],
    ['fantasy',                 'Fantasy Falls'],
    ['ff',                      'Fantasy Falls'],
    ['nf mokelumne',            'Fantasy Falls'],
    ['nf moke',                 'Fantasy Falls'],
    ['the moke',                'Fantasy Falls'],
    ['royal gorge',             'Royal Gorge'],
    ['royal',                   'Royal Gorge'],
    ['nf american',             'Royal Gorge'],
    ['postpile',                'Postpile'],
    ['devils postpile',         'Postpile'],
    ['sj',                      'Postpile'],
    ['san joaquin',             'San Joaquin R'],
    ['south merced',            'South Fork'],
    ['s merced',                'South Fork'],
    ['sf merced',               'South Fork'],
    ['tuolumne grand canyon',   'Tuolumne R (Grand Canyon)'],
    ['tgc',                     'Tuolumne R (Grand Canyon)'],
    ['gc t',                    'Tuolumne R (Grand Canyon)'],
    ['tuolumne gc',             'Tuolumne R (Grand Canyon)'],
    ['tuolumne',                'Tuolumne R'],
    ['main t',                  'Tuolumne R'],
    ['the t',                   'Tuolumne R'],
    ...
    ['hells',                   'Snake R (Hells Canyon)'],
    ['hc',                      'Snake R (Hells Canyon)'],
    ['owyhee',                  'Owyhee R'],
    // Idaho salmon (USGS)
    ...
    ['mfs',                     'Salmon R (Middle Fork)'],
    ['the middle fork',         'Salmon R (Middle Fork)'],
    ['south salmon',            'Salmon R (South Fork)'],
    ['sf salmon',               'Salmon R (South Fork)'],
    ['sfs',                     'Salmon R (South Fork)'],
    // Montana (USGS)
    ...
    ['middle flathead',         'Flathead R (Middle Fork)'],
    ['nf flathead',             'Flathead R (North Fork)'],
    ['north flathead',          'Flathead R (North Fork)'],
    ...
    ['lees ferry',              'Colorado R (Grand Canyon)'],
    ['gc',                      'Colorado R (Grand Canyon)'],
    ['the ditch',               'Colorado R (Grand Canyon)'],
    ['salt',                    'Salt R'],
    ['salt river',              'Salt R'],
    // Alaska (USGS)
    ['susitna',                 'Susitna R'],
    ...
    // BC / YT (WSC + NOAA)
    ['stikine',                 'Stikine R'],
    ['gc stikine',              'Stikine R'],
    ['iskut',                   'Iskut R'],
    ['alsek',                   'Alsek R'],
    ['tat',                     'Tatshenshini R'],
    ['tatshenshini',            'Tatshenshini R'],
    ['clore',                   'Zymoetz R (Copper)'],
    ['gc clore',                'Zymoetz R (Copper)'],
    ['copper',                  'Zymoetz R (Copper)'],
    ['copper river',            'Zymoetz R (Copper)'],
    ['zymoetz',                 'Zymoetz R (Copper)'],
    ['calor',                   'Zymoetz R (Copper)'],
