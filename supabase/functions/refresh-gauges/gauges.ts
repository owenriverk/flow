...
// low/high: paddling ranges verified against AW reach pages.
...
export const GAUGES: GaugeConfig[] = [
  ...
  { key: 'klamath',            name: 'Klamath R',        location: 'Orleans, CA',             source: 'usgs', site: '11523000', text_key: 'klamath',          gauge_url: 'https://waterdata.usgs.gov/monitoring-location/11523000/', low: 1000,  high: 25000 },
  ...
  { key: 'chilko',  name: 'Chilko R',     location: 'Chilko Lake, BC',     source: 'wsc', site: '08MA002', text_key: 'chilko',  gauge_url: 'https://wateroffice.ec.gc.ca/report/real_time_e.html?stn=08MA002', low: 50,  high: 70   },
  ...
  { key: 'nf mokelumne', name: 'NF Mokelumne',   location: 'ab Tiger Creek, CA', source: 'cdec', site: 'M38', sensor: 20, dur: 'H', text_key: 'nf mokelumne', gauge_url: 'https://cdec.water.ca.gov/dynamicapp/staMeta?station_id=M38',  low: 700, high: 4000 },
  { key: 'cherry creek', name: 'Cherry Ck',       location: 'Early Intake, CA',   source: 'cdec', site: 'CEI', sensor: 20, dur: 'E', text_key: 'cherry creek', gauge_url: 'https://cdec.water.ca.gov/dynamicapp/staMeta?station_id=CEI',  low: 300, high: 600  },
  ...
  { key: 'mf feather',   name: 'MF Feather R',    location: 'Merrimac, CA',       source: 'cdec', site: 'MER', sensor: 20, dur: 'H', text_key: 'mf feather',   gauge_url: 'https://cdec.water.ca.gov/dynamicapp/staMeta?station_id=MER',  low: 700, high: 3000 },
  { key: 'mf american',  name: 'MF American R',   location: 'Oxbow, CA',          source: 'cdec', site: 'OXB', sensor: 20, dur: 'H', text_key: 'mf american',  gauge_url: 'https://cdec.water.ca.gov/dynamicapp/staMeta?station_id=OXB',  low: 700, high: 3000 },
  ...
  { key: 'nf american',  name: 'NF American R',   location: 'North Fork Dam, CA', source: 'cdec', site: 'NFD', sensor: 20, dur: 'E', text_key: 'nf american',  gauge_url: 'https://cdec.water.ca.gov/dynamicapp/staMeta?station_id=NFD',  low: 500, high: 2000 },
  { key: 'sf american',  name: 'SF American R',   location: 'Chili Bar, CA',      source: 'cdec', site: 'CBR', sensor: 20, dur: 'H', text_key: 'sf american',  gauge_url: 'https://cdec.water.ca.gov/dynamicapp/staMeta?station_id=CBR',  low: 800, high: 8000 },

  // ── Dreamflows / California virtual gauges (cfs) ──────────────────
  // Community-preferred gauges; Dreamflows aggregates multiple upstream
  // sensor sources into a single virtual gauge per run.
  { key: 'tuolumne',    name: 'Tuolumne R',    location: 'at Mushroom, CA',      source: 'dreamflows', site: '214', text_key: 'tuolumne',    gauge_url: 'https://www.dreamflows.com/', low: 700,  high: 2000 },
  { key: 'kings',       name: 'Middle Kings R', location: 'Rodgers Crossing, CA', source: 'dreamflows', site: '100', text_key: 'kings',       gauge_url: 'https://www.dreamflows.com/', low: 1000, high: 3000 },
  { key: 'dinkey creek',name: 'Dinkey Ck',      location: 'Dinkey Meadow, CA',    source: 'dreamflows', site: '454', text_key: 'dinkey creek', gauge_url: 'https://www.dreamflows.com/', low: 180,  high: 500  },
  { key: 'kern',        name: 'Kern R',          location: 'above Fairview Dam, CA', source: 'dreamflows', site: '681', text_key: 'kern',     gauge_url: 'https://www.dreamflows.com/', low: 400,  high: 5000 },
];
