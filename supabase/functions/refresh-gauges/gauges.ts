...
export const GAUGES: GaugeConfig[] = [
  ...
  { key: 'upper cherry', name: 'Upper Cherry Ck', location: 'CA',              source: 'cdec', site: 'UCC', sensor: 20, dur: 'E', text_key: 'west cherry', gauge_url: 'https://cdec.water.ca.gov/dynamicapp/staMeta?station_id=UCC',  low: null, high: null },
